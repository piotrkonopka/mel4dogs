...
import { navigation, siteInfo, socialLinks } from "@/content/site";
    ...
    >
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between md:h-20">
          ...
          {/* Social Icons + CTA Button Desktop */}
          ...
          <div className="flex items-center gap-3 md:hidden">
            ...
            <button
              type="button"
              className="inline-flex items-center justify-center rounded-md p-2 text-gray-700 transition-colors hover:bg-gray-100 hover:text-gray-900 focus:ring-2 focus:ring-orange-600 focus:outline-none focus:ring-inset"
