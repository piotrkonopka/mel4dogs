            ...
            <div className="mt-6 flex gap-4">
              {socialLinks.map((social) => (
                <a
                  key={social.platform}
                  href={social.url}
                  className="rounded-full bg-gray-800 p-2 transition-colors hover:bg-orange-600 focus:ring-2 focus:ring-orange-600 focus:ring-offset-2 focus:ring-offset-gray-900 focus:outline-none"
